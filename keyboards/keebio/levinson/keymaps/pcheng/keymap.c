...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    ...
    */
    [_RAISE] = LAYOUT_ortho_4x12(
        ...
        _______, KC_UNDS, KC_MINS, KC_PLUS, KC_EQL,  KC_LEQ,  _______, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, KC_GRV,
        _______, _______, KC_ARRW, KC_LT,   KC_GT,   KC_GEQ,  _______, KC_LCBR, KC_RCBR, KC_SLSH, KC_QUES, _______,
